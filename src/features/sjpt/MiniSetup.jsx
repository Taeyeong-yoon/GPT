...
import { checkMiniAccess, FREE_TRIAL_COUNT, PRO_MONTHLY_SJPT } from '../../services/miniUsage';
    ...
    <div className="screen screen--cta-pad">
      ...
      {!loading && blocked && (reason === 'trial_expired' || reason === 'trial_count') && !isPro && (
        <div className="sub-gate sub-gate--exhausted">
          ...
          <p className="sub-gate__desc">무료 SJPT 미니 테스트는 3일 {FREE_TRIAL_COUNT}회입니다.<br/>Pro 구독으로 월 {PRO_MONTHLY_SJPT}회 이용하세요.</p>
