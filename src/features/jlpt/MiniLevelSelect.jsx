...
import { checkMiniAccess, FREE_WEEKLY_JLPT, PRO_MONTHLY_JLPT } from '../../services/miniUsage';
    ...
    <div className="screen screen--cta-pad">
      ...
      {!loading && blocked && reason === 'weekly' && !isPro && (
        <div className="sub-gate sub-gate--exhausted">
          ...
          <p className="sub-gate__desc">무료 JLPT 미니 테스트는 주 {FREE_WEEKLY_JLPT}회입니다.<br/>다음 주 월요일에 초기화되거나, Pro 구독으로 월 {PRO_MONTHLY_JLPT}회 이용하세요.</p>
        ...
        {!loading && access?.canStart && (
          <p className="sub-usage">
            {isPro
              ...
              : `이번 주 ${access.weekUsed ?? 0}/${FREE_WEEKLY_JLPT}회 사용 · 남은 ${FREE_WEEKLY_JLPT - (access.weekUsed ?? 0)}회`}
          </p>
        )}
